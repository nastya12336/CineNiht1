...
const moviesDatabase = {
    ...
    action: [
        ...
        },
        {
            ...
            description: "Бессмертная классика. Киборг-терминатор (Арнольд Шварценеггер) теперь reprogrammed для защиты юного Джона Коннора, будущего лидера сопротивления, от нового, более совершенного жидкометаллического терминатора Т-1000.",
            poster: "img/безумная макс.jfif",
            mood: "action",
            reviews: [
                { user: "Иван", rating: 5, comment: "Визуальный шедевр!" },
        ...
        },
         {
            ...
            description: "Один из эталонов жанра. Полицейский Джон Макклейн (Брюс Уиллис) в одиночку противостоит банде террористов, захвативших небоскреб в канун Рождества, где находится его жена.",
            poster: "img/безумная макс.jfif",
            mood: "action",
            reviews: [
                { user: "Иван", rating: 5, comment: "Визуальный шедевр!" },
